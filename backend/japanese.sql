...
(27, 2, 'きぼう', '希望', 'Hy vọng', '成功を希望する。', 0, '2026-04-29 10:46:11'),
(28, 2, 'よやく', '予約', 'Đặt trước', 'レストランを予約しました。', 0, '2026-04-29 10:46:11'),
(29, 2, 'さんか', '参加', 'Tham gia', 'イベントに参加します。', 0, '2026-04-29 10:46:11'),
(30, 2, 'しっぱい', '失敗', 'Thất bại', 'テストに失敗した。', 0, '2026-04-29 10:46:11'),
